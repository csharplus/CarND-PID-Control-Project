...
// Regular speed without throttle PID
bool enable_pid_throttle = false;
double max_throttle = 0.3;

// Faster speed is possible by enabling throttle PID
// Comment out the previous code, and uncomment the following
// bool enable_pid_throttle = true;
...
int main() {
   ...
   */
  PID pid_steering;
  // pid_steering.Init(0.1, 0.001, 3.0);
